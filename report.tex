...
The open-source \emph{Fat Tree Visualizer}\footnote{\url{https://github.com/h8liu/ftree-vis}} provides an interactive tool for exploring these topologies. In this assignment we extend the visualizer with three additional topology modules (Jupiter, Amazon, Meta), a BFS-based path analysis engine, and an exact bisection bandwidth algorithm, then use the tool to answer each sub-question of Question~5.
...
The full source code is available as an appendix and at \url{https://github.com/h8liu/ftree-vis}.
